...
//   const { getBookStoreVocabularySheet, addBookStoreVocabularySheet } = useVocabulary();
...
//     }
//   }, [popNewBottomSheet, getBookStoreVocabularySheet, addBookStoreVocabularySheet, clearStack]);

//   const showBookStoreAddBottomSheet = useCallback((bookStoreVocabularySheetId) => {
//     const bookStoreVocabularySheet = getBookStoreVocabularySheet(bookStoreVocabularySheetId);
//     pushNewBottomSheet(
//       AddBookStore,
//       { name: bookStoreVocabularySheet.name, onCancel: handleClose, onSet: () => handleAdd(bookStoreVocabularySheetId) },
//       { isBackdropClickClosable: false, isDragToCloseEnabled: true }
//     );
//   }, [getBookStoreVocabularySheet, pushNewBottomSheet, handleClose, handleAdd]);
...
//       }
//     );
//   }, [getBookStoreVocabularySheet, pushNewBottomSheet, handleClose, showBookStoreAddBottomSheet]);
...
// export const PreviewBookStore = ({bookStoreVocabularySheet, onCancel, onSet }) => {
...
// export const AddBookStore = ({ name, onCancel, onSet }) => {
