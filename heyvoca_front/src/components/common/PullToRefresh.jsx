...
//
// 당겨서 새로고침 래퍼 — 바텀 탭 5개(홈·단어장·찾기·상점·마이)의 스크롤 루트와, 목록형
// 풀시트(단어장 내부·보석 내역·초대 내역·계정·복습 일정·서점 미리보기·상점)의 스크롤 루트를
// 감싼다. 학습 화면(TakeTest)과 바텀시트 내부에는 쓰지 않는다 — 바텀시트는 위로 당겨 닫는
// 제스처(framer drag)와 겹치고, 학습 화면은 새로고침할 목록이 없다.
//
