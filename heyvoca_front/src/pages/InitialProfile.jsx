...
const InitialProfile = () => {
  ...
  useEffect(() => {
    if(step == 1){
      profileRefs.current.name.focus();
    }
  }, [step]);
  ...
  const handleNextBtn = (target) => {
    if(step == 1){
      const name = profileRefs.current.name.value;
      setStep(2);
    }
    else if(step == 2){
      const levelMap = {
      ...
      profileRefs.current.level.value = levelMap[target]
      setStep(3);
    }
        ...
        ">
          <button
            className="
              ...
              bg-[#FFFFFF]
            "
          onClick={() => handleNextBtn("Lv 1. 초등학생")}
          >
            Lv 1. 초등학생
          </button>
          <button
            className="
              ...
              bg-[#FFFFFF]
            "
          onClick={() => handleNextBtn("Lv 2. 중학생")}
          >
            Lv 2. 중학생
          </button>
          <button
            className="
              ...
              bg-[#FFFFFF]
            "
          onClick={() => handleNextBtn("Lv 3. 고등학생")}
          >
            Lv 3. 고등학생
          </button>
          <button
            className="
              ...
              bg-[#FFFFFF]
            "
          onClick={() => handleNextBtn("Lv 4. 대학생 이상")}
          > 
            Lv 4. 대학생 이상
          </button>
        </ul>
